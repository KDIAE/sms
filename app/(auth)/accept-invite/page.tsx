  ...
  if (success) {
    return (
      <div className="text-center py-6 flex flex-col items-center gap-4">
        ...
        <div>
          <h2 className="text-[18px] font-bold text-[#212529]">Account activated!</h2>
          <p className="text-[13px] text-slate-500 mt-1">
            Your password has been set. Redirecting you to login…
          </p>
        </div>
        <Link href="/login" className="text-[13px] text-[#007BFF] hover:underline flex items-center gap-1.5">
  ...
  return (
    <>
      <div className="text-center mb-7 mt-6">
        <h1 className="text-[22px] font-bold text-[#212529]">Set your password</h1>
...
function InvalidInvite() {
  return (
    <div className="text-center py-6 flex flex-col items-center gap-4">
      ...
      <div>
        <h2 className="text-[18px] font-bold text-[#212529]">Invalid invitation</h2>
        <p className="text-[13px] text-slate-500 mt-1">
    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#F8FAFC] px-4">
      ...
      >
        ...
        <CardContent className="px-8 pb-6 pt-0">
          {token ? <AcceptInviteForm token={token} /> : <InvalidInvite />}
        </CardContent>
      </Card>
    </div>
  );
